...
namespace Client.Scripts.ECS_Feature.System
{
    internal class SpawnCellObjectSystem : IEcsRunSystem
    {
        ...
        private readonly EcsFilter<SpawnTreeData> _tempSpawnData;
        ...
        public void Run()
        {
            ...
            foreach (var index in _cells)
            {
                    ...
                    !cell.Has<TakenCell>())
                {
                    ...
                    var newTree = Object.Instantiate(spawnData.Get<SpawnTreeData>().TreePrefab,
                    ...
                    tree.Get<OnSetTreeEvent>().TypeOfTree = spawnData.Get<SpawnTreeData>().TreeName;
                    tree.Get<CellObject>().title = spawnData.Get<SpawnTreeData>().TreeName;
                    tree.Get<OnExpEvent>().ExpAmount = spawnData.Get<SpawnTreeData>().ExpAmount;
                    tree.Get<CellObject>().currentCycleState = spawnData.Get<SpawnTreeData>().ProductionCycleTime;
                    ...
                    // Set resources data
                    resources.gold -= spawnData.Get<SpawnTreeData>().Price; 
