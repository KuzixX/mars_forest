    ...
    internal class SpawnCellObjects : IEcsRunSystem
    {
        ...
        public void Run()
        {
            ...
            foreach (var index in _cells)
            {
                ...
                ref var cellPosition = ref _interaction.Get1(0);
                    ...
                    !cell.Has<TakenCell>())
                {
                    ...
                    var newTree = Object.Instantiate(spawnData.Get<SpawnCellObjectData>().TreePrefab, cell.Get<Position>().transform.position, Quaternion.identity);
