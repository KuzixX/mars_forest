...
namespace Client.Scripts.ECS_Feature.Second_Order_Move
{
    internal class SecondOrderSystem : IEcsRunSystem
    {
        private readonly EcsFilter<MainCharacter, Position, SecondOrderComponent> _mainCharacterFilter;
        ...
        public void Run()
        {
            ...
            {
                ref var variables = ref _mainCharacterFilter.Get3(0);
            ...
            {
                ref var mainCharacter = ref _mainCharacterFilter.Get2(0);
                ref var targetPos = ref _filter.Get1(index);
                ref var var = ref _mainCharacterFilter.Get3(0);
